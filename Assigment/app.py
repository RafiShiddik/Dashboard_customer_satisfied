...
@st.cache_data 
def load_data():
    return pd.read_csv("Assigment/data/df_no_outliers.csv") # Perbaiki backslash jadi slash
...
def load_all_models():
    models = {}
    models["KNN"] = joblib.load("Assigment/model_baru/best_KNN_model.pkl")
    models["Decision Tree"] = joblib.load("Assigment/model_baru/best_Decision_tree_model.pkl")
    models["Random Forest"] = joblib.load("Assigment/model_baru/best_random_forest_model.pkl")
    return models
